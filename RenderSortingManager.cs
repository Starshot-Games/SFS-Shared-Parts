...
namespace SFS
{
    public class RenderSortingManager : MonoBehaviour
    {
        ...
        [ShowInInspector] public Dictionary<(Material, int), Material> partMaterials = new();
        ...
        public Material GetEngineGlowMaterial(int renderQueue)
        {
            return GetMaterial(renderQueue, Base.partsLoader.engineGlowMaterial);
        }
