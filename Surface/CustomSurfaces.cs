...
namespace SFS.Parts.Modules
{
    ...
    public sealed class CustomSurfaces : SurfaceData, I_InitializePartModule
    {
        ...
        [Space]
        public List<ComposedSurfaces> pointsArray = new() { new ComposedSurfaces() };
    ...
    {
        public Composed_Vector2[] points =
        {
            new Composed_Vector2(Vector2.left),
            new Composed_Vector2(Vector2.right),
        };
